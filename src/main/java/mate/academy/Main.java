...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Shopping cart registered for user.");
        ...
        for (Ticket tickets : shoppingCart.getTickets()) {
            System.out.println("- Ticket ID: " + tickets.getId()
                    + ", Movie: " + tickets.getMovieSession().getMovie().getTitle()
                    + ", ShowTime: " + tickets.getMovieSession().getShowTime().format(formatter));
        }
    }
}
